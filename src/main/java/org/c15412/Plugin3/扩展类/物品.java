...
public class 物品 extends ItemStack {
    public 物品(final Material 类型) {
        super(类型, 1);
    }

    public 物品(final Material 类型, final int 数量) {
        super(类型, 数量);
    }

    public 物品(final 物品 物品) {
        super(物品);
    }

    public 物品(final ItemStack 物品) {
        super(物品);
    }

    public static ItemMeta 设置无法破坏属性(ItemMeta 物品数据) {
        物品数据.setUnbreakable(true);
        return 物品数据;
    }

    public static void 设置无法破坏(ItemMeta 物品数据) {
        物品数据.setUnbreakable(true);
    }

    public static void 设置无法破坏(ItemStack 物品) {
        ItemMeta 物品数据 = 物品.getItemMeta();
        设置无法破坏(物品数据);
        物品.setItemMeta(物品数据);
    }

    public static void 设置物品数据(ItemStack 物品, ItemMeta 物品数据) {
        物品.setItemMeta(物品数据);
    }

    public static void 设置注释(ItemStack 物品, List<String> 注释) {
        ItemMeta 数据 = 物品.getItemMeta();
        设置注释(数据, 注释);
        物品.setItemMeta(数据);
    }

    public static void 设置注释(ItemMeta 物品数据, List<String> 注释) {
        物品数据.setLore(注释);
    }

    public static void 设置注释(ItemMeta 物品数据, String... 注释) {
        设置注释(物品数据, Arrays.asList(注释));
    }

    public static void 设置注释(ItemStack 物品, String... 注释) {
        设置注释(物品, Arrays.asList(注释));
    }

    public static void 设置注释(ItemStack 物品, int 行数, String 修改的注释) {
        ItemMeta 数据 = 物品.getItemMeta();
        设置注释(数据, 行数, 修改的注释);
        物品.setItemMeta(数据);
    }
